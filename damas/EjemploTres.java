 ...
 * Ejemplo 3.
 * 
 * Basado en la figura c) del pdf del trabajo.
 * 
...
public class EjemploTres{
    ...
    public static void main(String[] args){
         ...
         */
        if (Game.eatAllBlacks(10, whites, blacks)) {
            
            System.out.println("No deberia aparecer esta impresion");

        }

        System.out.println("\n No existe ficha ganadora\n");
